// Portfolio data for the developer website
// Note: Image imports would be replaced with actual image assets in a real project

export const educationData = [
    { 
        course: "B.Tech", 
        transition: "down", 
        highlights: "I got passed with 70.9%, I was deeply into Embedded Systems, created Mobile operated ROBO for Rescue also into renewable energy created a prototype of Dance Floor generated Electricity from Piezoelectric Material.", 
    ...
    { 
        course: "PG-Diploma", 
        transition: "down", 
        highlights: "I got passed with 78%, Those 6 months were awsome !! I was into Linux, Kernel, C, Embedded Systems, Raspberry PI, Begale Borad bla bla bla...", 
        stream: "Diploma in Embedded System Design", 
        college: "ACTS, PUNE", 
    ...
    { 
        course: "Intermediate", 
        transition: "up", 
        highlights: "I got passed with 75.6%, highly motivated to pursue Engineering Career.", 
        stream: "Maths", 
        college: "S.S.V. Inter College, Faizabad", 
        university: "U.P.Board" 
    },
    { 
        course: "HighSchool", 
        transition: "up", 
        highlights: "I got passed with 73%, I was just figuring out if I have got some potential.", 
        stream: "Genral", 
        college: "S.S.V. Inter College, Faizabad", 
        university: "U.P.Board" 
    },
...
export const projectDetails = [
    {
        ...
        transition: 'right',
        technology: ['JavaScript', 'React', 'NodeJS', 'OAuth', 'Nginx', 'Keycloak', 'JWT', 'HTML', 'CSS'],
        highlights: []
    },
    {
    ...
    }, 
    {
        ...
        transition: 'right',
        technology: ['JavaScript', 'NodeJS', 'HTML', 'CSS', 'jQuery', 'SQLite'],
        highlights: [
    ...
    },
    {
        ...
        link: 'https://www.kpit.com/',
        transition: 'right',
        technology: ['JavaScript', 'Angular', 'NodeJS', 'Express', 'PostgreSQL', 'HTML', 'CSS'],
        highlights: [
...
export const socialMedia = [
    { id: "Facebook", name: "Facebook", href: "https://www.facebook.com/surajpandey5954" },
    { id: "Twitter", name: "Twitter", href: "https://twitter.com/SuryaPr68949074" },
    { id: "Email", name: "Email", href: "mailto:suryaprakash.cdac@gmail.com" },
    { id: "GitHub", name: "GitHub", href: "https://github.com/surya5954" },
    { id: "LinkedIn", name: "LinkedIn", href: "https://www.linkedin.com/in/surya5954/" },
    { id: "Medium", name: "Medium", href: "https://suryaprakash-pandey.medium.com/" }
];
